# Microprocessor Systems - Assignment 2: Morse Code Game
...
```
cd existing_repo
git remote add origin https://gitlab.scss.tcd.ie/nnath/game-morse-code.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.scss.tcd.ie/nnath/game-morse-code/-/settings/integrations)
